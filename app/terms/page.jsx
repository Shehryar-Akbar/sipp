...
export const metadata = generateMetadata(seoConfig.terms)
      ...
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-6 sm:p-8 lg:p-12">
        ...
        <section className="mb-8">
          ...
          <div className="mb-6">
            ...
            <p className="text-lg sm:text-xl! text-gray-700 leading-none!">
              ...
              preparation or correction services.
            </p>
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="mb-6">
            ...
            <p className="text-lg sm:text-xl! text-gray-700 leading-none!">
              ...
              additional charges and delay delivery.
            </p>
          </div>
          ...
          <div className="mb-6">
            ...
            <p className="text-lg sm:text-xl! text-gray-700 leading-none!">
              ...
              exact color matching, particularly for digitally displayed colors.
            </p>
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="mb-6">
            ...
            <ul className="space-y-2 text-lg sm:text-xl! text-gray-700 ml-4">
              ...
              <li>
                <span className="font-medium">Large Orders:</span> 50% deposit
                required upon order confirmation, with the balance due before
                delivery
              </li>
              <li>
                <span className="font-medium">Corporate Accounts:</span> Payment
                terms may be negotiated on a case-by-case basis
              </li>
            </ul>
          </div>
        ...
        <section className="mb-8">
          ...
          <div className="mb-6">
            ...
            <ul className="space-y-2 text-lg sm:text-xl! text-gray-700 ml-4">
              ...
              <li>
                <span className="font-medium">Delivery:</span> Local delivery
                services are available in Kabul and surrounding areas for an
                additional fee
              </li>
              <li>
                <span className="font-medium">Courier:</span> International or
                distant deliveries will be arranged through third-party courier
        ...
        <section className="mb-8">
          ...
          <div className="mb-6">
            ...
            <ul className="space-y-2 text-lg sm:text-xl! text-gray-700 ml-4">
              ...
              <li>
                <span className="font-medium">Color:</span> Slight variations
                are acceptable
              </li>
              <li>
                <span className="font-medium">Cutting and Trimming:</span> ±2mm
                tolerance
              </li>
              <li>
                <span className="font-medium">Registration:</span> ±1mm
                tolerance
              </li>
            </ul>
          </div>
        ...
        <section className="mb-8">
          ...
          <div className="mb-6">
            ...
            <ul className="space-y-2 text-lg sm:text-xl! text-gray-700 ml-4">
              ...
              <li>
                Orders cannot be cancelled once production has commenced. Full
                payment is required for work completed
              </li>
            </ul>
          </div>
        ...
        <section className="mb-8">
          ...
          <div className="mb-6">
            ...
            <p className="text-lg sm:text-xl! text-gray-700 leading-none!">
              ...
              claims arising from copyright or trademark infringement.
            </p>
          </div>
        ...
        <section className="mb-8">
          ...
          <div className="mb-6">
            ...
            <ul className="space-y-2 text-lg sm:text-xl! text-gray-700 ml-4">
              ...
              <li>Third-party intellectual property claims</li>
            </ul>
          </div>
        ...
        <section className="mb-8">
          ...
          <p className="text-lg sm:text-xl! text-gray-700 leading-none!">
            ...
            actions, labor disputes, material shortages, or equipment failure.
          </p>
        </section>
